...
function updateQuests($currentQuestNumber) {
    $jsonFilePath = "../../saves/players/0/d2mode/questlist.json";

    // Read the JSON file
    $jsonData = json_decode(file_get_contents("../../saves/players/0/d2mode/questlist.json"), true);
